...
path =  "F:\\April-2017\\Nov 17\\fintech" # Set path of new directory here
os.chdir(path)
new_d = os.getcwd() 
...
for s in dir_file_list: # Number of HTML +1
...
#Export CSV
with open("fintech_Nov2017.csv", 'w', encoding='utf-8', newline = '') as a:
